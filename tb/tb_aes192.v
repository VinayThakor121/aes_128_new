// AES-192 Testbench – NIST FIPS-197 Appendix C.2
...
// NIST FIPS-197 Appendix C.2 test vector
...
localparam [127:0] EXPECTED_CT = 128'hdda97ca4864cdfe06eaf70a0ec0d7191;
...
// DUT: Encrypt
// --------------------------------------------------------
aes_encrypt #(.KEY_SIZE(192)) u_enc (
    .clk        (clk),
    .rst        (rst),
    .plaintext  (PLAINTEXT),
    .key        (KEY),
...
aes_decrypt #(.KEY_SIZE(192)) u_dec (
    .clk        (clk),
    .rst        (rst),
    .ciphertext (ct_latch),
    .key        (KEY),
...
initial begin
    $display("====================================================");
    $display("  AES-192 Test – NIST FIPS-197 Appendix C.2");
    $display("====================================================");
    $display("  Key       : %h", KEY);
